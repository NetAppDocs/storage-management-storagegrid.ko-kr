...
---
= NetApp 콘솔에서 StorageGRID 관리하는 데 알려진 문제
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
== 업데이트된 표시 이름이 NetApp 콘솔에 나타나지 않습니다.

사이트나 그리드에 대한 새 표시 이름을 정의하기 위해 이름 바꾸기 절차를 사용하는 경우, 새 표시 이름은 NetApp 콘솔에 반영되지 않습니다.  NetApp 콘솔 내에서 시스템은 새로운 표시 이름이 아닌 시스템 이름을 계속 표시합니다.
