...
* https://docs.netapp.com/us-en/console-setup-admin/media/notice.pdf["NetApp 콘솔에 대한 알림"^]
* link:media/NOTICE-storageservices.pdf["StorageGRID 시스템의 NetApp 콘솔 관리에 대한 알림"^]
